...
public class ThumbPhotoView extends RelativeLayout{
    ...
    public void showSelected(boolean showSelected){
        if(showSelected){
            photo_thumbview_selected.setBackgroundResource(R.drawable.checkbox_album_pressed);
        }else{
            photo_thumbview_selected.setBackgroundResource(R.drawable.checkbox_album_normal);
        }
    }
